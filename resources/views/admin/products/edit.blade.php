...
@section('content')
    ...
    <form action="{{route('admin.products.update', ['product' => $product->id])}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="productImage">Fotos do Produto</label>
            <input name="photos[]" type="file" id="productImage" class="form-control-file @error('photos.*') is-invalid @enderror" multiple>
